...
export default {
  ...
  computed: {
    ...
    example2() {
      return `<j-slider :min="20" :max="40" step="5" />`;
    },
    example3() {
      return `<j-slider v-model="initValue" />`;
    },
    example4() {
      return `<j-slider v-model="value" :show-tooltip="false" />`;
    },
    example5() {
      return `<j-slider disabled />`
    }
  }
};
</script>
