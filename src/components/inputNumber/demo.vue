...
<script>
  ...
  export default {
    ...
    computed: {
      example1() {
        return `<j-input-number v-model="value"/>`;
      },
      example2() {
        return `<j-input-number disabled/>`;
      },
      example3() {
        return `<j-input-number :step="5" v-model="stepValue"/>`;
      },
      example4() {
        return `<j-input-number :max="20" :min="0" :step="5" v-model="limitValue"/>`;
      }
    }
  };
</script>
